...
public class NotificationRenderer
{
    ...
    /// <paramref name="amount"/> is a dollar value with cents as the
    /// fractional part (e.g. 149.99), exactly as carried by
    /// OrderPlacedEvent.TotalAmount and stored in OrderNotification.OrderTotal.
    /// </summary>
